...
<!-- Tabela de alunos -->
<?php if ( $turmas && $tipo_lista === 'transporte' ) : ?>
        ...
        <table class="zebra">
            <thead>
                <tr>
                    ...
                    <th>Necessidade de transporte adaptado</th>
                </tr>
            </thead>
            <tbody>
                <?php
                foreach ( $turma['alunosTurma'] as $aluno ) :
                    ...
                    <tr>
                        ...
                        <td><?php echo esc_html( $data_nascimento->format( 'd/m/Y' ) ?? '-' ); ?></td>
                        <td><?php echo $aluno['possuiDeficiencia'] == 1 ? 'Sim' : 'Não'; ?></td>
                    </tr>
                    <?php
                endforeach;
                ?>
...
<?php if ( $turmas && $tipo_lista === 'produtor' ) : ?>
    <?php foreach ( $turmas as $turma ) : ?>
        <table class="zebra">
            <thead>
                <tr>
                    ...
                    <th width="250">Nome do estudante</th>
                    <th>Turma</th>
                    <th>Necessidade de roteiro acessível</th>
...
<?php if ( isset( $acompanhantes ) && !empty( $acompanhantes ) ) : ?>
    <table class="zebra">
        <thead>
            <tr>
                <th>RF/CPF do acompanhante</th>
                <th width="250">Nome dos acompanhante</th>
                <th>Necessidade de transporte adaptado</th>
            </tr>
        </thead>
        <tbody>
