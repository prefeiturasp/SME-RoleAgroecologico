...
/**
 * 4. GERAR NÚMERO DA PRÓXIMA VERSÃO
*/
 ...
 * ============================================================
 *
 * A versão é determinada exclusivamente pelos arquivos
 * existentes na pasta:
 *
 * wp-content/uploads/monitoramento-hortas/
 *
 * Exemplo:
 *
 * levantamento-001-2026-08-20-10-30-00.xlsx
 * levantamento-002-2026-08-21-14-15-00.xlsx
 * levantamento-005-2026-08-25-09-20-00.xlsx
 *
 * Próxima versão:
 *
 * 006
...
function mh_get_next_version() {
    ...
    foreach ($arquivos as $arquivo) {
        ...
        /**
         * Procurar a versão no nome.
         * Exemplo: levantamento-015-2026-08-26-16-30-00.xlsx
         * Resultado: 015
         */
...
function mh_download_planilha()
{
    ...
    $post_id = isset($_GET['levantamento'])
        ? absint($_GET['levantamento'])
        : 0;
    ...
    if (
        ...
        wp_die(
            'O arquivo da planilha não foi encontrado.'
        );
    }
...
add_action(
    'admin_post_mh_excluir_levantamento',
...
function mh_excluir_levantamento()
{
    ...
    if (!current_user_can(MH_CAPABILITY)) {
        wp_die(
            'Você não possui permissão para excluir levantamentos.'
        );
    }
    ...
    if (!$resultado) {
        ...
        mh_redirect_error(
            'Não foi possível excluir o levantamento.'
        );
    }
